...
export default function AdminDashboard() {
  ...
  const buildRegistrationLink = (eventId) => `${window.location.origin}/events/${eventId}/register`
  ...
  const downloadRegistrationQR = async (eventId) => {
    try {
      ...
      if (!dataUrl) { setMessage('Failed to generate QR'); return }
                ...
                <div className="event-content">
                  <div className="event-header">
                    ...
                    <div className="event-actions">
                      ...
                      >
                        <span>Copy Reg Link</span>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                          <path d="M16 8V6C16 4.89543 15.1046 4 14 4H6C4.89543 4 4 4.89543 4 6V14C4 15.1046 4.89543 16 6 16H8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                          <rect x="8" y="8" width="12" height="12" rx="2" stroke="currentColor" strokeWidth="2"/>
                        </svg>
                      </button>
                      <button 
                        className="toggle-regs-btn"
                        onClick={() => downloadRegistrationQR(ev.id)}
                        title="Download registration QR"
                      >
