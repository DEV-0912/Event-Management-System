...
// GET /api/ads/all -> admin list of all ads
router.get('/all', authMiddleware, isAdmin, async (_req, res) => {
  try {
...
// POST /api/ads -> admin create ad { title, image(dataURL or URL), link, active }
